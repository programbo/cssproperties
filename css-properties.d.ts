...
export type SingleOrArray<Properties, T extends keyof Properties> = { [P in T]: Properties[P] | Array<Properties[P]> }

type CSSPropertiesComplete = SingleOrArray<CSSPropertiesCompleteSingle, keyof CSSPropertiesCompleteSingle>
